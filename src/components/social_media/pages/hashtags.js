...
function demo(){
    document.getElementById('hashtag').value="#așaamauzit";
}
...
function split_hashtag(){
    var text=document.getElementById('hashtag').value;
    
    if(text.length<2 || text[0]!="#"){alert("Please enter a valid hashtag"); return ;}
