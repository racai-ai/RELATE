function gridAdd(){
            ...
            $("#popup-dialog-crud").dialog({ title: "Adaugare Resursa", buttons: {
                Add: function () {
                    var data={
...
$(document).ready(function () {
        ...
        obj.dataModel = {
            ...
            dataType:"json",
            method:"GET",
            url:"index.php?path=datag/list_get&pin={{pin}}",
        ...
        $grid = $("#grid").pqGrid(obj);
          ...
          $("#popup-dialog-crud").dialog({ width: 1000, modal: true,
