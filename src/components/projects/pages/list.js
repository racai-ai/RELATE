...
function gridAdd(){
            ...
            $("#popup-dialog-crud").dialog({ title: "Add Project", buttons: {
                Add: function () {
                    var data={
                        name:$frm.find("input[name='name']").val(),
                        ignore:$frm.find("input[name='ignore']")[0].checked?1:0,
                    ...
                    $.ajax({
                        cache:false,
                        url:"index.php?path=projects/list_add",
                        data:{data:JSON.stringify(data)},
                        method:"POST"
                    }).done(function(data) {
                        data=JSON.parse(data);
                            if(data.status==false)
                              alert("Cannot add project! ["+data.reason+"]");
...
$(document).ready(function () {
        ...
        var obj = {
            ...
            , rowDblClick: function( event, ui ) {
                window.location.href="index.php?path=projects/project&name="+ui.rowData.name;
            }            
        };
        ...
        obj.colModel = [
            ...
            { title: "Ignore", dataType: "string", dataIndx: "ignore", filter: { type: 'textbox', condition: 'contain', listeners: ['keyup'] }},
        ...
        obj.dataModel = {
            ...
            dataType:"json",
            method:"GET",
            url:"index.php?path=projects/get_list",
