...
function renderResource($res){
	$desc=$res->getData("description_long",$res->getData("description_short","No description"));
	...
	$resHtml.='<div class="resourceItem"><b>License:</b>&nbsp;&nbsp;'.htmlentities($res->getData("license","Not provided")).'</div>';
	...
	if((is_array($durls) && !empty($durls)) || (is_array($files) && !empty($files))){
		$resHtml.='<div class="resourceItem"><b>Download:</b></div><div class="resourceItemContent"><ul>';
		if(is_array($files)){
			foreach($files as $file=>$data){
				$url="index.php?path=repository/get_file&resource=".$res->getName()."&file=".$file;
	...
	$resHtml.='<div class="resourceItem"><b>Description:</b></div><div class="resourceItemContent '.$descClass.'"><p>'.htmlentities($desc).'</p></div>';
