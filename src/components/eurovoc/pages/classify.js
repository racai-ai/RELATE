...
function classify(){
    ...
    loadDataForm("inputForm",function(data){
        ...
        var html='<table>';
        html+='<tr><th colspan="2">EUROVOC ID</th></tr>';
        
        for(var i=0;i<data.ids.length;i++)
            html+='<tr><td>'+data.ids[i].id+'</td><td>'+data.ids[i].text+'</td></tr>';


        html+='<tr><td colspan="2">&nbsp;</td></tr>';

        html+='<tr><th colspan="2">MT</th></tr>';
        for(var i=0;i<data.mt.length;i++)
            html+='<tr><td>'+data.mt[i].mt+'</td><td>'+data.mt[i].text+'</td></tr>';

        html+='<tr><td colspan="2">&nbsp;</td></tr>';
        html+='<tr><th colspan="2">Domains</th></tr>';
        for(var i=0;i<data.domains.length;i++)
            html+='<tr><td>'+data.domains[i].d+'</td><td>'+data.domains[i].text+'</td></tr>';
